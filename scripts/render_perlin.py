...
def render_prototype_set() -> list[Path]:
    clips = [
        ...
        dict(
            target_speed_m_s=2.70,
            duration_s=10.0,
            start_x_m=6.0,
            title="PROTOTYPE  RIGID 2-LINK  PID  2.7 m/s  LIMIT",
            stem="prototype_pid_2p7ms",
            acceleration_m_s2=1.8,
        ),
        dict(
            target_speed_m_s=2.80,
            duration_s=8.0,
            start_x_m=3.5,
            title="PROTOTYPE  RIGID 2-LINK  PID  2.8 m/s  FAIL",
            stem="prototype_pid_2p8ms_fail",
            acceleration_m_s2=1.8,
        ),
    ]
