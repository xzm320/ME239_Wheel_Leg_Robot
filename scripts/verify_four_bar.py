...
def verify() -> dict[str, object]:
    ...
    for step in range(round(1.2 / model.opt.timestep)):
        ...
        # Both synchronized stages carry a 3000 N/m spring. The first-stage
        # servo therefore sees 6000 N/m through the 1:1 synchronization.
        feedforward_command = desired_extension * ramp * (1.0 + 6000.0 / 8000.0)
